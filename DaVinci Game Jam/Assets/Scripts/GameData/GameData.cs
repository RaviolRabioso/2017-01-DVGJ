	...
	*/
	...
	public void SortQuestions()
	{
        ...
        _questions.Add(new Question("El Gremio reclama una mejora salarial para los trabajadores",
            ...
            new Answer("Tomen todo lo que quieran", 5, -3, -5, 0, 5),
            new Answer("Que lo defina el congreso", -1, -1, 0, 0, -3)));

        _questions.Add(new Question("La economía esta por el piso y hay que elevar los impuestos",
            new Answer("Que lo pague el pueblo, es su economía", -3, 1, 5, 0, 1),
            new Answer("Que lo pague la clase alta, ellos se beneficiaron con la actual crisis", 3, -4, 5, 0, -3),
            new Answer("Que lo paguen todos, menos yo obviamente", -2, -2, 5, 0, -1)));

        _questions.Add(new Question("Muchos innmigrantes les pareció buena idea entrar a nuestro país",
            new Answer("Sólo queremos atletas, que aprendan a saltar muros", 2, 3, 1, -3, 1),
            new Answer("Son todos bienvenidos!", -2, -3, -1, 3, 1),
            new Answer("Mirá vo...", -3, -3, -2, 0, -3)));

        _questions.Add(new Question("Nuestro pequeño país vecino está por entrar en guerra con una potencia mundial",
            new Answer("Que la coman, apoyamos a la potencia", -2, -1, -1, +2, +2),
            new Answer("Son nuestros hermanos, los apoyaremos", -1, -2, -3, 3, 2),
            new Answer("Mándele a ambos buena suerte", 0, 0, 1, -3, -1)));
